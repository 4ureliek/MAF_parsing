...
##########################################################################################################
print STDERR "\n --- Analyzing gaps [from file birds_reestimated_archosaurRef.9sp.maf]
        According to the following phylogeny:
                  ...
                  NEOGNATHAE|  |----------- colLiv1     Columbia livia = Rock pigeon              
                     ...
                     AVES|  GALLO       |-- galGal4     Gallus gallus = Chicken  
                      |--|  
                      |  |----------------- strCam0     Struthio camelus = Ostrich                  
                    --|   	     
...
my @not_neognathae = ("strCam0","anoCar2");

my @neoaves = ("falPer1","taeGut2","geoFor1","melUnd1","colLiv1");
my @not_neoaves = ("anaPla1","galGal4","strCam0","anoCar2");
my @gallo = ("anaPla1","galGal4");
my @not_gallo = ("falPer1","taeGut2","geoFor1","melUnd1","colLiv1","strCam0","anoCar2");

my @austr = ("falPer1","taeGut2","geoFor1","melUnd1");
my @not_austr = ("colLiv1","anaPla1","galGal4","strCam0","anoCar2");

my @passeri = ("taeGut2","geoFor1","melUnd1");
my @not_passeri = ("falPer1","colLiv1","anaPla1","galGal4","strCam0","anoCar2");

my @finch = ("taeGut2","geoFor1");
my @not_finch = ("melUnd1","falPer1","colLiv1","anaPla1","galGal4","strCam0","anoCar2");
...
$files = MAFmicrodel::split_gaps(\@aves,\@not_aves,"gaps.1-30.not-shared.all","aves",$in,$path,$files,$bedtools);
